   ...
   <article>
    <section className="flex flex-col text-white py-32  w-full h-full text-left gap-4">
     ...
     <ul className="list-disc">
      <li className="">Identificar riscos fiscais e propor ações para mitigá-los.</li>
      <li className="">Planejar estratégias tributárias que alinhem a carga tributária com os objetivos de negócios da empresa.</li>
      <li className="">Assegurar que todas as declarações e pagamentos de impostos estejam corretos e sejam feitos em tempo hábil, evitando multas e juros.</li>
      <li className="">Aproveitar incentivos fiscais e benefícios oferecidos pela legislação, que muitas vezes são desconhecidos pelos gestores.</li>
     </ul>
