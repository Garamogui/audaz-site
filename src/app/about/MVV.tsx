   ...
   <div className="w-full flex flex-col justify-center items-center bg-background-alt p-20 gap-10">
    ...
    <div className="flex items-start justify-center gap-3 ">
     ...
     <div className="flex gap-5 w-1/3">
      <h3 className="bg-secondary px-2 text-3xl text-foreground rounded-sm size-10 justify-center text-center items-center">1</h3>
     ...
     <div className="flex gap-5 w-1/3">
      <h3 className="bg-secondary px-2 text-3xl text-foreground rounded-sm size-10 justify-center text-center items-center">2</h3>
      <div className="flex flex-col gap-2  ">
     ...
     <div className="flex gap-5 w-1/3">
      <h3 className="bg-secondary px-2 text-3xl text-foreground rounded-sm size-10 justify-center text-center items-center">3</h3>
      <div className="flex flex-col gap-2  ">
